...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-istanbul/node_modules/istanbul/lib/store/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-istanbul/node_modules/istanbul/lib/store/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-istanbul/node_modules/istanbul/lib/store/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * @main store
 */
<span class="fstat-no" title="function not covered" >function Store(/* options */) {</span>}
&nbsp;
...
Store.prototype = {
     ...
     */
    set: <span class="fstat-no" title="function not covered" >function (/* key, contents */) {</span> <span class="cstat-no" title="statement not covered" >throw new Error("set: must be overridden"); </span>},
    /**
     ...
     */
    get: <span class="fstat-no" title="function not covered" >function (/* key */) {</span> <span class="cstat-no" title="statement not covered" >throw new Error("get: must be overridden"); </span>},
    /**
     * returns a list of all known keys
     * @method keys
     * @return {Array} an array of seen keys
     */
    keys: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >throw new Error("keys: must be overridden"); </span>},
    /**
     ...
     */
    hasKey: <span class="fstat-no" title="function not covered" >function (/* key */) {</span> <span class="cstat-no" title="statement not covered" >throw new Error("hasKey: must be overridden"); </span>},
    /**
     ...
     */
    getObject: <span class="fstat-no" title="function not covered" >function (key) {</span>
<span class="cstat-no" title="statement not covered" >        return JSON.parse(this.get(key));</span>
    },
    /**
     ...
     */
    setObject: <span class="fstat-no" title="function not covered" >function (key, object) {</span>
<span class="cstat-no" title="statement not covered" >        return this.set(key, JSON.stringify(object));</span>
    }
};
&nbsp;
