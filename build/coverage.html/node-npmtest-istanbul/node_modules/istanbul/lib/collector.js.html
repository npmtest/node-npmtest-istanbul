...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-istanbul/node_modules/istanbul/lib/collector.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-istanbul/node_modules/istanbul/lib/collector.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-istanbul/node_modules/istanbul/lib/</a> &#187; collector.js</div>
</div>
<div class="body">
 ...
 *      calculations.
 */
<span class="fstat-no" title="function not covered" >function Collector(options) {</span>
<span class="cstat-no" title="statement not covered" >    options = options || {};</span>
<span class="cstat-no" title="statement not covered" >    this.store = options.store || new MemoryStore();</span>
}
&nbsp;
Collector.prototype = {
    /**
     ...
     */
    add: <span class="fstat-no" title="function not covered" >function (coverage /*, testName */) {</span>
<span class="cstat-no" title="statement not covered" >        var store = this.store;</span>
<span class="cstat-no" title="statement not covered" >        Object.keys(coverage).forEach(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >            var fileCoverage = coverage[key];</span>
<span class="cstat-no" title="statement not covered" >            if (store.hasKey(key)) {</span>
<span class="cstat-no" title="statement not covered" >                store.setObject(key, utils.mergeFileCoverage(fileCoverage, store.getObject(key)));</span>
            } else {
<span class="cstat-no" title="statement not covered" >                store.setObject(key, fileCoverage);</span>
            }
        });
    },
    /**
     ...
     */
    files: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this.store.keys();</span>
    },
    /**
     ...
     */
    fileCoverageFor: <span class="fstat-no" title="function not covered" >function (fileName) {</span>
<span class="cstat-no" title="statement not covered" >        var ret = this.store.getObject(fileName);</span>
<span class="cstat-no" title="statement not covered" >        utils.addDerivedInfoForFile(ret);</span>
<span class="cstat-no" title="statement not covered" >        return ret;</span>
     ...
     */
    getFinalCoverage: <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >            ret[file] = that.fileCoverageFor(file);</span>
        });
<span class="cstat-no" title="statement not covered" >        return ret;</span>
    },
    /**
...
<span class="cstat-no" title="statement not covered" >        this.store.dispose();</span>
    }
};
&nbsp;
